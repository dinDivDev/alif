...
import guru from "./assets/guruLagman.jpg";
import boso from "./assets/bosoLagman.jpg";
import veganLagman from "./assets/veganLagman.jpg";
import mushuro from "./assets/mushuro.jpg";
import kazanKebob from "./assets/kazanKebob.jpg";
import ganFan from "./assets/ganFan.jpg";
import dabandzhi from "./assets/dapanji.jpg";
import jarovnya from "./assets/jarovnya.jpg";
import plov from "./assets/plov.jpg";
import geshNaan from "./assets/geshNaan.jpg";
import manty from "./assets/manty.jpg";
import besh from "./assets/besh.jpg";
import kuurdak from "./assets/kuurdak.jpg";
import beefshteks from "./assets/beefshteks.jpg";
import cutlets from "./assets/catletsSecond.jpg";
import brizol from "./assets/brizol.jpg";
import gulyash from "./assets/gulyash.jpg";
import vareniki from "./assets/vareniki.jpg";
import meetInAPot from "./assets/meetInAPot.jpeg";
...
export const entrees = [
  ...
  },
  {
    ...
    name: "Kazan Kebab",
    description:
      "Kazan Kebab, also known as Kazan Kebabi, is a traditional Turkish dish named after the special cooking vessel called kazan. It typically consists of tender pieces of meat, such as lamb or beef, cooked with onions, tomatoes, peppers, and various spices in the kazan, resulting in a rich and flavorful stew-like preparation.",
    price: "$18",
    qty: 0,
  },
  {
